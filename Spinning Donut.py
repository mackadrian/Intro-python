#ASCII Spinning Donut by: Giovanni Code. https://www.youtube.com/watch?v=zn4Yvxww58g&t=76s
import pygame
import colorsys
import math
...
# display_surface = pygame.display.set.set_mode((0,0), pygame.FULLSCREEN)
...
while run:
    ...
    for j in range(0, 628, theta_spacing): # from 0 to 2pi
        for i in range(0, 628, phi_spacing): # from 0 to 2pi
            ...
            o = int(x + columns * y) # 3D x-coordinate after rotation
